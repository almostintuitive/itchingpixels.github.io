...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.35d7f2f72a1583fee45509262ec38cd7f3e8b7351493bb1a0cd2e163a3729a89.js',function(){input.required=false;search();});}
